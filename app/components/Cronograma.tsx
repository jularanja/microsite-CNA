  ...
  return (
    <div id='cronograma' className='mx-auto flex justify-center '>
      <div className='grid grid-cols-1 gap-4 max-w-screen '>
        <div className='min-h-screen bg-yellow-300 flex justify-center items-center rounded-2xl px-14'>
          <div className='container mx-auto p-12 max-w-screen-lg '>
            <h1 className=' text-headingColor text-4xl md:text-5xl font-bold from-current mb-8 text-center italic'>
              Cronograma anual
            </h1>
              ...
              <div>
                <div>
                  <div className='bg-white max-w-sm rounded-lg shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105'>
                    <div>
                      <div className='px-8 py-2 h-max flex flex-col justify-center'>
                ...
                <div>
                  <div className='bg-white mb-2 max-w-sm rounded-lg shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105 h-max'>
                    <div>
                      <div className='px-10 py-2 pb-6 h-max '>
                        ...
                        <h3 className='text-2xl text-primary font-bold text-center mb-2 '>Feira Agropecuária</h3>
                        <p>
